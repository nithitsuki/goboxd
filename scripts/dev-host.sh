...
GOBOXD_LANGS="${GOBOXD_LANGS:-py3,c,cpp,bash,js,rust,go,lua,perl,r,py2,gawk,dash,nasm,nim,octave,prolog,elisp,zig,julia,crystal,clojure,groovy,dotnet,coffeescript,odin,pony,vlang,pwsh,raku,cobol,smalltalk}"
