...
| 2 | Shell-style directory commands | Use `os.MkdirTemp` and `os.RemoveAll`, no shell exec. Unit test `TestSecurityHole2NoShellCommands` verifies no shell patterns exist. | `internal/runner/runner.go:22`, `internal/api/handlers_test.go:280` |
